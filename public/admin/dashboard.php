...
if (!isset($GLOBALS['databases']['primary']) || !($GLOBALS['databases']['primary'] instanceof PDO)) {
    ...
    $config = require PROJECT_ROOT . '/src/Core/Config/load_country.php';
...
$participantsPath = PROJECT_ROOT . "/src/Core/Config/countries/{$countryCode}/participants_{$countryCode}.json";
$participants = [];
        ...
        <div class="grid-2">
            ...
            <div class="card">
                ...
                <div style="padding: 20px;">
                    ...
                    <p><strong>Last Cron:</strong> <?php echo date('Y-m-d H:i:s', filemtime(PROJECT_ROOT . '/src/Application/logs/cron.log') ?: time()); ?></p>
